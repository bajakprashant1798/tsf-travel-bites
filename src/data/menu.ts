...
export type Tag = "spicy" | "sweet" | "long-shelf-life" | "healthy";
...
export const menu: MenuItem[] = [
  ...
  },
  {
    ...
    unit: "/Pc.",
    category: "breakfast",
    tags: ["long-shelf-life", "healthy"],
  },
  {
    id: "multigrain-bhakhri",
    name: "Multigrain Bhakhri",
    price: 50,
    unit: "/Pc.",
    category: "breakfast",
    tags: ["long-shelf-life", "healthy"],
  ...
  {
    id: "soji-besan-chilla",
    name: "Soji / Besan Chilla",
    price: 80,
    unit: "/Pc.",
    category: "breakfast",
    tags: [],
  ...
  {
    id: "nylon-pauva-chevdo",
    name: "Nylon Pauva Chevdo (Sweet & Salty)",
    price: 250,
    unit: "",
    category: "ready-to-eat",
    tags: ["sweet", "long-shelf-life"],
  },
  {
    id: "sado-chevdo",
    name: "Sado Chevdo",
  ...
  {
    id: "namkeen-shakarpara",
    name: "Namkeen Shakarpara",
    price: 110,
    unit: "",
    category: "ready-to-eat",
    tags: ["long-shelf-life"],
